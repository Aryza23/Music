...
def start_pannel():  
    buttons  = [
            ...
            [ 
                InlineKeyboardButton(text="📨Official Channel", url="https://t.me/LaylaList"),
                InlineKeyboardButton(text="📨Support Group", url="https://t.me/AwesomeSupport")
            ],
    ]
